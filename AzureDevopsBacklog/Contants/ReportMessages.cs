namespace AzureDevopsBacklog.Contants
{
    public static class ReportMessages
    {
        ...
        public static string ReportDescription(double effort) => $"Haftalık efordan({effort}) az iş tamamlamış kişiler ve tamamlanmamış maddeleri aşağıdaki gibidir. </br></br> ";
